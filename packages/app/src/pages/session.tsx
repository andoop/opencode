...
export default function Page() {
  ...
  const historyCurrentBranch = createMemo(() => {
    ...
    const ref = head?.refs.find((item) => item.kind === "local") ?? head?.refs.find((item) => item.kind === "remote")
                          ...
                          <For each={openedTabs()}>
                            {(tab) => {
                              ...
                              const commentedLines = createMemo(() =>
                                fileComments().map((comment) => comment.selection),
                              )
                              ...
                              const setCommenting = (
                                value:
                                  | typeof note.commenting
                                  | ((value: typeof note.commenting) => typeof note.commenting),
                              ...
                              const setPositions = (
                                value:
                                  | typeof note.positions
                                  | ((value: typeof note.positions) => typeof note.positions),
                              ...
                              const syncCodeScroll = () => {
                                ...
                                if (next.length === codeScroll.length && next.every((el, i) => el === codeScroll[i]))
                                  return
                  ...
                  >
                    <div class="flex items-center gap-1 px-2 pt-2">
                      ...
                      <Tooltip placement="bottom" value={language.t("session.files.refresh")}>
                        ...
                        >
                          {fileTreeRefreshing()
                            ? language.t("session.files.refreshing")
