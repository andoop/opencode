...
export const dict = {
  ...
  "dialog.provider.opencode.note": "使用 RealseeCode Zen 或 API 密钥连接",
  ...
  "dialog.model.unpaid.freeModels.title": "RealseeCode 提供的免费模型",
  ...
  "provider.connect.apiKey.description":
    "输入你的 {{provider}} API 密钥以连接帐户，并在 RealseeCode 中使用 {{provider}} 模型。",
  ...
  "provider.connect.opencodeZen.line1": "RealseeCode Zen 为你提供一组精选的可靠优化模型，用于代码智能体。",
  ...
  "provider.connect.oauth.code.visit.suffix": " 获取授权码，以连接你的帐户并在 RealseeCode 中使用 {{provider}} 模型。",
  ...
  "prompt.git.aria": "Git 分支与工作树信息",
  "prompt.git.badge": "Git",
  "prompt.git.currentBranch": "当前分支",
  "prompt.git.trackingRemote": "追踪远端",
  "prompt.git.worktree": "工作树",
  "prompt.git.loading": "正在加载详情...",
  "prompt.git.branches": "分支",
  "prompt.git.submodules": "子模块",
  ...
  "prompt.toast.attachmentTooLarge.description": "单个附件不能超过 {{size}}。",
  "prompt.toast.attachmentLimit.title": "附件数量过多",
  "prompt.toast.attachmentLimit.description": "每条消息最多附加 {{count}} 个文件。",
  "prompt.toast.attachmentPending.title": "附件仍在上传",
  "prompt.toast.attachmentPending.description": "请等待所有附件上传完成后再发送，或移除上传失败的附件。",
  "prompt.toast.attachmentUploadFailed.title": "附件上传失败",
  "prompt.toast.attachmentUploadFailed.description": "附件无法上传。",
  "prompt.toast.attachmentUploadFailed.network": "上传时发生网络错误。",
  "prompt.toast.attachmentUploadFailed.noSession": "请先创建或打开会话，再附加文件。",
  ...
  "toast.update.description": "RealseeCode 有新版本 ({{version}}) 可安装。",
  ...
  "error.page.report.prefix": "请将此错误报告给 RealseeCode 团队",
  ...
  "error.chain.mcpFailed": 'MCP 服务器 "{{name}}" 启动失败。注意: RealseeCode 暂不支持 MCP 认证。',
  ...
  "session.files.history": "历史",
  "session.files.all": "所有文件",
  "session.files.refresh": "刷新",
  "session.files.refreshing": "刷新中...",
  "session.git.noChanges": "工作区无变更",
  "session.history.empty": "未找到提交记录",
  "session.history.loading": "正在加载历史...",
  "session.history.loadingCommit": "正在加载提交详情...",
  "session.history.selectCommit": "选择一个提交以查看详情",
  "session.history.project": "项目",
  "session.history.currentCommit": "当前提交",
  "session.history.author": "作者",
  "session.history.date": "日期",
  "session.history.parents": "父提交",
  "session.history.changedFiles": "变更文件",
  "session.history.noDiff": "这个提交没有可展示的 diff",
  "session.history.openFile": "打开文件",
  ...
  "sidebar.gettingStarted.line1": "RealseeCode 提供免费模型，你可以立即开始使用。",
  ...
  "admin.page.description": "管理用户、已开放项目和会话审计数据",
  "admin.action.backHome": "返回首页",
  "admin.action.createUser": "新建用户",
  "admin.projectRegistry.title": "项目注册表",
  "admin.projectRegistry.description": "预先登记本地项目，非管理员只能打开这些允许的项目",
  "admin.projectRegistry.add": "添加项目",
  "admin.projectRegistry.column.name": "名称",
  "admin.projectRegistry.column.description": "介绍",
  "admin.projectRegistry.column.directory": "路径",
  "admin.projectRegistry.column.added": "添加时间",
  "admin.projectRegistry.column.actions": "操作",
  "admin.projectRegistry.error.addFailed": "添加项目失败",
  "admin.projectRegistry.error.notGit": "所选路径及其父目录中未找到 Git 仓库：{{directory}}",
  "admin.projectRegistry.error.onlyGit": "只有 Git 项目才能加入项目注册表：{{directory}}",
  "admin.projectRegistry.error.onlyGitGeneric": "只有 Git 项目才能加入项目注册表",
  "admin.projectDialog.addTitle": "添加项目",
  "admin.projectDialog.editTitle": "编辑项目：{{project}}",
  "admin.projectDialog.addDescription": "为项目添加介绍，方便其他用户理解项目用途",
  "admin.projectDialog.editDescription": "更新这个已注册项目的显示名称和介绍",
  "admin.projectDialog.displayName": "显示名称",
  "admin.projectDialog.displayNamePlaceholder": "可选项目名称",
  "admin.projectDialog.description": "项目介绍",
  "admin.projectDialog.descriptionPlaceholder": "可选项目介绍",
  "admin.projectDialog.directory": "项目路径",
  "admin.audit.title": "会话审计",
  "admin.audit.description": "查看用户提问和基础跨用户会话活动",
  "admin.audit.refresh": "刷新审计",
  "admin.audit.searchPlaceholder": "搜索会话标题 / 项目 / 最新提问",
  "admin.audit.filter.allUsers": "全部用户",
  "admin.audit.filter.allProjects": "全部项目",
  "admin.audit.loading": "正在加载会话审计...",
  "admin.audit.loadFailed": "加载会话审计失败",
  "admin.audit.viewPrompts": "查看对话",
  "admin.audit.column.user": "用户",
  "admin.audit.column.project": "项目",
  "admin.audit.column.session": "会话",
  "admin.audit.column.prompts": "提问 / 总消息",
  "admin.audit.column.updated": "更新时间",
  "admin.audit.column.latestPrompt": "最新提问",
  "admin.audit.column.actions": "操作",
  "admin.audit.summary.sessions": "会话数",
  "admin.audit.summary.users": "用户数",
  "admin.audit.summary.projects": "项目数",
  "admin.audit.summary.prompts": "用户提问数",
  "admin.audit.summary.lastActivity": "最近活动",
  "admin.audit.promptDetail.title": "对话详情",
  "admin.audit.prompts.loading": "正在加载对话...",
  "admin.audit.prompts.loadFailed": "加载对话失败",
  "admin.audit.prompts.empty": "没有找到可展示的对话内容。",
  "admin.storage.title": "存储空间管理",
  "admin.storage.description": "透视运行时存储，并清理缓存、孤儿工作区和已归档会话空间",
  "admin.storage.refresh": "刷新存储",
  "admin.storage.loading": "正在扫描存储...",
  "admin.storage.error.loadFailed": "加载存储摘要失败",
  "admin.storage.error.requestFailed": "存储请求失败",
  "admin.storage.summary.total": "纳管空间",
  "admin.storage.summary.reclaimable": "安全可回收",
  "admin.storage.summary.items": "对象数",
  "admin.storage.summary.highRisk": "高风险",
  "admin.storage.categories.title": "存储分类",
  "admin.storage.categories.description": "选择要纳入清理预览的分类。",
  "admin.storage.users.title": "所有用户",
  "admin.storage.users.description": "按用户桶透视所有空间占用，并可按所有者筛选清理范围。",
  "admin.storage.users.all": "全部用户",
  "admin.storage.user.global": "全局",
  "admin.storage.user.unknown": "未知所有者",
  "admin.storage.user.local": "本地用户",
  "admin.storage.column.select": "选择",
  "admin.storage.column.user": "用户",
  "admin.storage.column.category": "分类",
  "admin.storage.column.count": "数量",
  "admin.storage.column.size": "大小",
  "admin.storage.column.reclaimable": "可回收",
  "admin.storage.column.highRisk": "高风险",
  "admin.storage.column.object": "对象",
  "admin.storage.column.risk": "风险",
  "admin.storage.column.reason": "原因",
  "admin.storage.force": "强制清理高风险对象，包括已归档会话",
  "admin.storage.plan": "预览清理",
  "admin.storage.planning": "正在生成预览...",
  "admin.storage.cleanup": "执行清理",
  "admin.storage.cleaning": "正在清理...",
  "admin.storage.planTitle": "清理预览",
  "admin.storage.planSummary": "将清理 {{count}} 个对象，预计释放 {{bytes}}，跳过 {{skipped}} 个。",
  "admin.storage.confirmCleanup": "确认删除 {{count}} 个存储对象，预计释放 {{bytes}}？",
  "admin.storage.resultTitle": "清理结果",
  "admin.storage.resultSummary": "已清理 {{removed}} 个对象，释放 {{bytes}}，失败 {{failed}} 个。",
  "admin.storage.category.cache": "缓存",
  "admin.storage.category.workspaces": "工作区",
  "admin.storage.category.closedWorkspaces": "已关闭工作区",
  "admin.storage.category.snapshots": "过期快照",
  "admin.storage.category.tmpUploads": "临时上传",
  "admin.storage.category.archivedSessions": "已归档会话",
  "admin.storage.category.orphanWorkspaces": "孤儿工作区",
  "admin.storage.category.orphanUserWorktrees": "孤儿用户工作树",
  "admin.storage.category.danglingStorage": "悬空存储",
  "admin.storage.risk.low": "低",
  "admin.storage.risk.medium": "中",
  "admin.storage.risk.high": "高",
  ...
  "settings.general.row.language.description": "更改 RealseeCode 的显示语言",
  "settings.general.row.appearance.title": "外观",
  "settings.general.row.appearance.description": "自定义 RealseeCode 在你的设备上的外观",
  "settings.general.row.theme.title": "主题",
  "settings.general.row.theme.description": "自定义 RealseeCode 的主题。",
  ...
  "settings.updates.row.startup.description": "在 RealseeCode 启动时自动检查更新",
  ...
  "settings.updates.toast.latest.description": "你正在使用最新版本的 RealseeCode。",
  ...
  "settings.commands.description": "管理全局自定义命令，并查看所有可用命令。",
  "settings.commands.empty": "尚未配置全局命令。",
  "settings.commands.section.global": "全局命令",
  "settings.commands.section.all": "所有可用命令",
  "settings.commands.source.command": "配置",
  "settings.commands.source.mcp": "MCP",
  "settings.commands.source.skill": "技能",
  "settings.commands.source.builtin": "内置",
  "settings.commands.action.add": "添加命令",
  "settings.commands.form.create": "添加命令",
  "settings.commands.form.edit": "编辑命令",
  "settings.commands.form.name": "名称",
  "settings.commands.form.name.placeholder": "my-command",
  "settings.commands.form.template": "模板",
  "settings.commands.form.template.placeholder": "输入提示词模板...",
  "settings.commands.form.description": "描述",
  "settings.commands.form.description.placeholder": "这个命令做什么？",
  "settings.commands.form.agent": "智能体",
  "settings.commands.form.agent.placeholder": "可选的智能体名称",
  "settings.commands.form.model": "模型",
  "settings.commands.form.model.placeholder": "例如 provider/model-id",
  "settings.commands.form.subtask": "作为子任务运行",
  "settings.commands.form.subtask.description": "将此命令作为后台子任务执行。",
  ...
  "settings.commands.validation.templateRequired": "模板为必填项",
  "settings.mcp.title": "MCP",
  "settings.mcp.description": "管理当前项目或全局配置中的远程 MCP 服务。",
  "settings.mcp.scope.label": "作用域",
  "settings.mcp.scope.project": "当前项目",
  "settings.mcp.scope.global": "全局",
  "settings.mcp.path": "配置文件",
  "settings.mcp.empty": "当前作用域下还没有远程 MCP 配置。",
  "settings.mcp.action.add": "添加 MCP",
  "settings.mcp.action.refresh": "刷新",
  "settings.mcp.action.refreshing": "刷新中...",
  "settings.mcp.state.disabled": "启动时禁用",
  "settings.mcp.status.unknown": "未加载",
  "settings.mcp.tools.title": "工具",
  "settings.mcp.tools.empty": "这个 MCP 服务当前没有暴露工具。",
  "settings.mcp.tools.disconnected": "先连接这个 MCP 服务，才能查看和控制它的工具。",
  "settings.mcp.tools.toast.updated": "MCP 工具权限已更新",
  "settings.mcp.toast.refreshed": "MCP 已刷新",
  "settings.mcp.form.create": "添加 MCP",
  "settings.mcp.form.edit": "编辑 MCP",
  ...
  "settings.mcp.form.enabled": "启动时启用",
  "settings.mcp.form.enabled.description": "禁用后会保留在配置里，但不会自动连接。",
  "settings.mcp.validation.nameRequired": "请输入名称",
  "settings.mcp.validation.urlRequired": "请输入 URL",
  "settings.mcp.validation.urlInvalid": "请输入有效的 URL",
  "settings.mcp.toast.created": "MCP 已创建",
  "settings.mcp.toast.updated": "MCP 已更新",
  "settings.mcp.toast.deleted": "MCP 已删除",
  "settings.mcp.delete.confirm": "确定要删除 MCP {{name}} 吗？",
