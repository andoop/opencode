...
export const dict = {
  ...
  "admin.audit.promptDetail.title": "提问详情",
  "admin.audit.prompts.loading": "正在加载提问...",
  "admin.audit.prompts.loadFailed": "加载提问失败",
  "admin.audit.prompts.empty": "没有找到用户提问。",
