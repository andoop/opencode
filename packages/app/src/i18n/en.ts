export const dict = {
  ...
  "dialog.model.unpaid.freeModels.title": "Free models provided by RealseeCode",
  ...
  "provider.connect.apiKey.description":
    "Enter your {{provider}} API key to connect your account and use {{provider}} models in RealseeCode.",
  "provider.connect.apiKey.label": "{{provider}} API key",
  "provider.connect.apiKey.placeholder": "API key",
  "provider.connect.apiKey.required": "API key is required",
  "provider.connect.opencodeZen.line1":
    "RealseeCode Zen gives you access to a curated set of reliable optimized models for coding agents.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    " to collect your authorization code to connect your account and use {{provider}} models in RealseeCode.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " and enter the code below to connect your account and use {{provider}} models in RealseeCode.",
  ...
  "prompt.dropzone.label": "Drop files here",
  ...
  "prompt.git.aria": "Git branch and worktree information",
  "prompt.git.badge": "Git",
  "prompt.git.currentBranch": "Current branch",
  "prompt.git.trackingRemote": "Tracking remote",
  "prompt.git.worktree": "Worktree",
  "prompt.git.loading": "Loading details...",
  "prompt.git.branches": "Branches",
  "prompt.git.submodules": "Submodules",
  ...
  "prompt.toast.attachmentTooLarge.description": "Each attachment must be {{size}} or smaller.",
  ...
  "prompt.toast.attachmentUploadFailed.noSession": "Create or open a session before attaching files.",
  ...
  "toast.update.description": "A new version of RealseeCode ({{version}}) is now available to install.",
  ...
  "error.page.report.prefix": "Please report this error to the RealseeCode team",
  ...
  "error.chain.mcpFailed": 'MCP server "{{name}}" failed. Note, RealseeCode does not support MCP authentication yet.',
  ...
  "session.files.history": "History",
  "session.files.all": "All files",
  "session.files.refresh": "Refresh",
  "session.files.refreshing": "Refreshing...",
  "session.git.noChanges": "Working tree clean",
  "session.history.empty": "No commits found",
  "session.history.loading": "Loading history...",
  "session.history.loadingCommit": "Loading commit...",
  "session.history.selectCommit": "Select a commit to view its details",
  "session.history.project": "Project",
  "session.history.currentCommit": "Current commit",
  "session.history.author": "Author",
  "session.history.date": "Date",
  "session.history.parents": "Parents",
  "session.history.changedFiles": "Changed files",
  "session.history.noDiff": "No diff available for this commit",
  "session.history.openFile": "Open file",
  ...
  "session.new.autoWorktree": "Each session will automatically create its own worktree and branch",
  ...
  "sidebar.gettingStarted.line1": "RealseeCode includes free models so you can start immediately.",
  ...
  "admin.page.description": "Manage users, approved projects, and session audit data",
  "admin.action.backHome": "Back to home",
  "admin.action.createUser": "Create user",
  "admin.projectRegistry.title": "Project registry",
  "admin.projectRegistry.description": "Pre-register local projects that non-admin users are allowed to open",
  "admin.projectRegistry.add": "Add project",
  "admin.projectRegistry.column.name": "Name",
  "admin.projectRegistry.column.description": "Description",
  ...
  "admin.projectDialog.editDescription": "Update the display name and description for this registered project",
  "admin.projectDialog.displayName": "Display name",
  "admin.projectDialog.displayNamePlaceholder": "Optional project name",
  "admin.projectDialog.description": "Description",
  "admin.projectDialog.descriptionPlaceholder": "Optional project description",
  "admin.projectDialog.directory": "Directory",
  "admin.audit.title": "Session audit",
  "admin.audit.description": "Review user prompts and basic cross-user session activity",
  "admin.audit.refresh": "Refresh audit",
  "admin.audit.searchPlaceholder": "Search title / project / latest prompt",
  "admin.audit.filter.allUsers": "All users",
  "admin.audit.filter.allProjects": "All projects",
  "admin.audit.loading": "Loading session audit...",
  "admin.audit.loadFailed": "Failed to load session audit",
  "admin.audit.viewPrompts": "View conversation",
  "admin.audit.column.user": "User",
  "admin.audit.column.project": "Project",
  "admin.audit.column.session": "Session",
  "admin.audit.column.prompts": "Prompts / Messages",
  "admin.audit.column.updated": "Updated",
  "admin.audit.column.latestPrompt": "Latest prompt",
  "admin.audit.column.actions": "Actions",
  "admin.audit.summary.sessions": "Sessions",
  "admin.audit.summary.users": "Users",
  "admin.audit.summary.projects": "Projects",
  "admin.audit.summary.prompts": "User prompts",
  "admin.audit.summary.lastActivity": "Last activity",
  "admin.audit.promptDetail.title": "Conversation detail",
  "admin.audit.prompts.loading": "Loading conversation...",
  "admin.audit.prompts.loadFailed": "Failed to load conversation",
  "admin.audit.prompts.empty": "No displayable conversation content found.",
  "admin.storage.title": "Storage management",
  "admin.storage.description": "Inspect runtime storage and clean cache, orphan workspaces, and archived sessions",
  "admin.storage.refresh": "Refresh storage",
  "admin.storage.loading": "Scanning storage...",
  "admin.storage.error.loadFailed": "Failed to load storage summary",
  "admin.storage.error.requestFailed": "Storage request failed",
  "admin.storage.summary.total": "Tracked size",
  "admin.storage.summary.reclaimable": "Safe reclaimable",
  "admin.storage.summary.items": "Objects",
  "admin.storage.summary.highRisk": "High risk",
  "admin.storage.categories.title": "Storage categories",
  "admin.storage.categories.description": "Select the categories to include in the cleanup preview.",
  "admin.storage.users.title": "All users",
  "admin.storage.users.description": "Review storage usage across every user bucket and filter cleanup by owner.",
  "admin.storage.users.all": "All users",
  "admin.storage.user.global": "Global",
  "admin.storage.user.unknown": "Unknown owner",
  "admin.storage.user.local": "Local user",
  "admin.storage.column.select": "Select",
  "admin.storage.column.user": "User",
  "admin.storage.column.category": "Category",
  "admin.storage.column.count": "Count",
  "admin.storage.column.size": "Size",
  "admin.storage.column.reclaimable": "Reclaimable",
  "admin.storage.column.highRisk": "High risk",
  "admin.storage.column.object": "Object",
  "admin.storage.column.risk": "Risk",
  "admin.storage.column.reason": "Reason",
  "admin.storage.force": "Force high-risk cleanup, including archived sessions",
  "admin.storage.plan": "Preview cleanup",
  "admin.storage.planning": "Planning...",
  "admin.storage.cleanup": "Run cleanup",
  "admin.storage.cleaning": "Cleaning...",
  "admin.storage.planTitle": "Cleanup preview",
  "admin.storage.planSummary": "{{count}} objects selected, {{bytes}} estimated, {{skipped}} skipped.",
  "admin.storage.confirmCleanup": "Remove {{count}} storage objects and reclaim about {{bytes}}?",
  "admin.storage.resultTitle": "Cleanup result",
  "admin.storage.resultSummary": "Removed {{removed}} objects, reclaimed {{bytes}}, {{failed}} failed.",
  "admin.storage.category.cache": "Cache",
  "admin.storage.category.workspaces": "Workspaces",
  "admin.storage.category.closedWorkspaces": "Closed workspaces",
  "admin.storage.category.snapshots": "Stale snapshots",
  "admin.storage.category.tmpUploads": "Temporary uploads",
  "admin.storage.category.archivedSessions": "Archived sessions",
  "admin.storage.category.orphanWorkspaces": "Orphan workspaces",
  "admin.storage.category.orphanUserWorktrees": "Orphan user worktrees",
  "admin.storage.category.danglingStorage": "Dangling storage",
  "admin.storage.risk.low": "Low",
  "admin.storage.risk.medium": "Medium",
  "admin.storage.risk.high": "High",

  "app.name.desktop": "RealseeCode Desktop",
  ...
  "settings.general.row.language.description": "Change the display language for RealseeCode",
  "settings.general.row.appearance.title": "Appearance",
  "settings.general.row.appearance.description": "Customise how RealseeCode looks on your device",
  "settings.general.row.theme.title": "Theme",
  "settings.general.row.theme.description": "Customise how RealseeCode is themed.",
  ...
  "settings.updates.row.startup.description": "Automatically check for updates when RealseeCode launches",
  ...
  "settings.updates.toast.latest.description": "You're running the latest version of RealseeCode.",
  ...
  "settings.commands.description": "Manage global custom commands and view all available commands.",
  "settings.commands.empty": "No global commands configured yet.",
  "settings.commands.section.global": "Global Commands",
  "settings.commands.section.all": "All Available Commands",
  "settings.commands.source.command": "config",
  "settings.commands.source.mcp": "mcp",
  "settings.commands.source.skill": "skill",
  "settings.commands.source.builtin": "built-in",
  "settings.commands.action.add": "Add Command",
  "settings.commands.form.create": "Add Command",
  "settings.commands.form.edit": "Edit Command",
  "settings.commands.form.name": "Name",
  "settings.commands.form.name.placeholder": "my-command",
  "settings.commands.form.template": "Template",
  "settings.commands.form.template.placeholder": "Enter the prompt template...",
  "settings.commands.form.description": "Description",
  "settings.commands.form.description.placeholder": "What does this command do?",
  "settings.commands.form.agent": "Agent",
  "settings.commands.form.agent.placeholder": "Optional agent name",
  "settings.commands.form.model": "Model",
  "settings.commands.form.model.placeholder": "e.g. provider/model-id",
  "settings.commands.form.subtask": "Run as subtask",
  "settings.commands.form.subtask.description": "Execute this command as a background subtask.",
  ...
  "settings.commands.validation.templateRequired": "Template is required",
  "settings.mcp.title": "MCP",
  "settings.mcp.description": "Manage remote MCP servers for the current project or your global config.",
  "settings.mcp.scope.label": "Scope",
  "settings.mcp.scope.project": "Current project",
  "settings.mcp.scope.global": "Global",
  "settings.mcp.path": "Config file",
  "settings.mcp.empty": "No remote MCP servers configured in this scope.",
  "settings.mcp.action.add": "Add MCP",
  "settings.mcp.action.refresh": "Refresh",
  "settings.mcp.action.refreshing": "Refreshing...",
  "settings.mcp.state.disabled": "startup disabled",
  "settings.mcp.status.unknown": "not loaded",
  "settings.mcp.tools.title": "Tools",
  "settings.mcp.tools.empty": "No tools exposed by this MCP server.",
  "settings.mcp.tools.disconnected": "Connect this MCP server to inspect and control its tools.",
  "settings.mcp.tools.toast.updated": "MCP tool permission updated",
  "settings.mcp.toast.refreshed": "MCP refreshed",
  "settings.mcp.form.create": "Add MCP",
  "settings.mcp.form.edit": "Edit MCP",
  "settings.mcp.form.name": "Name",
  "settings.mcp.form.name.placeholder": "my-mcp-server",
  "settings.mcp.form.url": "URL",
  "settings.mcp.form.url.placeholder": "https://example.com/mcp",
  "settings.mcp.form.enabled": "Enable on startup",
  "settings.mcp.form.enabled.description": "Disabled servers stay in config but do not connect automatically.",
  "settings.mcp.validation.nameRequired": "Name is required",
  "settings.mcp.validation.urlRequired": "URL is required",
  "settings.mcp.validation.urlInvalid": "Enter a valid URL",
  "settings.mcp.toast.created": "MCP created",
  "settings.mcp.toast.updated": "MCP updated",
  "settings.mcp.toast.deleted": "MCP deleted",
