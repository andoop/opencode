...
export const dict = {
  ...
  "prompt.git.title": "Git 資訊",
  "prompt.git.description": "目前工作階段對應儲存庫的狀態資訊",
  "prompt.git.aria": "Git 分支與工作樹資訊",
  "prompt.git.badge": "Git",
  "prompt.git.currentBranch": "目前分支",
  "prompt.git.trackingRemote": "追蹤遠端",
  "prompt.git.worktree": "工作樹",
  "prompt.git.loading": "正在載入詳細資訊...",
  "prompt.git.branches": "分支",
  "prompt.git.submodules": "子模組",
  ...
  "session.files.history": "歷史",
  "session.files.all": "所有檔案",
  "session.git.noChanges": "工作樹沒有變更",
  "session.history.empty": "找不到提交紀錄",
  "session.history.loading": "正在載入歷史...",
  "session.history.loadingCommit": "正在載入提交詳細資訊...",
  "session.history.selectCommit": "請選取一個提交以檢視詳細資訊",
  "session.history.project": "專案",
  "session.history.currentCommit": "目前提交",
  "session.history.author": "作者",
  "session.history.date": "日期",
  "session.history.parents": "父提交",
  "session.history.changedFiles": "變更檔案",
  "session.history.noDiff": "此提交沒有可顯示的 diff",
  "session.history.openFile": "開啟檔案",
  ...
  "settings.commands.description": "管理全域自訂命令，並檢視所有可用命令。",
  "settings.commands.empty": "尚未設定全域命令。",
  "settings.commands.section.global": "全域命令",
  "settings.commands.section.all": "所有可用命令",
  "settings.commands.source.command": "設定",
  "settings.commands.source.mcp": "MCP",
  "settings.commands.source.skill": "技能",
  "settings.commands.source.builtin": "內建",
  "settings.commands.action.add": "新增命令",
  "settings.commands.form.create": "新增命令",
  "settings.commands.form.edit": "編輯命令",
  "settings.commands.form.name": "名稱",
  "settings.commands.form.name.placeholder": "my-command",
  "settings.commands.form.template": "範本",
  "settings.commands.form.template.placeholder": "輸入提示詞範本...",
  "settings.commands.form.description": "描述",
  "settings.commands.form.description.placeholder": "這個命令做什麼？",
  "settings.commands.form.agent": "代理程式",
  "settings.commands.form.agent.placeholder": "選填的代理程式名稱",
  "settings.commands.form.model": "模型",
  "settings.commands.form.model.placeholder": "例如 provider/model-id",
  "settings.commands.form.subtask": "作為子任務執行",
  "settings.commands.form.subtask.description": "將此命令作為背景子任務執行。",
  ...
  "settings.commands.validation.templateRequired": "範本為必填項",
