---
title: Zen
description: Curated list of models provided by RealseeCode.
---
...
RealseeCode Zen is a list of tested and verified models provided by the RealseeCode team.

:::note
RealseeCode Zen is currently in beta.
:::

Zen works like any other provider in RealseeCode. You login to RealseeCode Zen and get
...
:::tip
We tested a select group of models and providers that work well with RealseeCode.
:::
...
RealseeCode Zen is an AI gateway that gives you access to these models.

---

## How it works

RealseeCode Zen works like any other provider in RealseeCode.

1. You sign in to **<a href={console}>RealseeCode Zen</a>**, add your billing
   details, and copy your API key.
2. You run the `/connect` command in the TUI, select RealseeCode Zen, and paste your API key.
...
The [model id](/docs/config/#models) in your RealseeCode config
...
- GLM 4.7 Free is available on RealseeCode for a limited time. The team is using this time to collect feedback and improve the model.
- Kimi K2.5 Free is available on RealseeCode for a limited time. The team is using this time to collect feedback and improve the model.
- MiniMax M2.1 Free is available on RealseeCode for a limited time. The team is using this time to collect feedback and improve the model.
- Big Pickle is a stealth model that's free on RealseeCode for a limited time. The team is using this time to collect feedback and improve the model.
...
4. Have **no lock-in** by allowing you to use it with any other coding agent. And always let you use any other provider with RealseeCode as well.
