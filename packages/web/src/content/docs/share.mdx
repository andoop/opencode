---
title: Share
description: Share your RealseeCode conversations.
---

RealseeCode's share feature allows you to create public links to your RealseeCode conversations, so you can collaborate with teammates or get help from others.
...
When you share a conversation, RealseeCode:
...
RealseeCode supports three sharing modes that control how conversations are shared:

---

### Manual (default)

By default, RealseeCode uses manual sharing mode. Sessions are not shared automatically, but you can manually share them using the `/share` command:
