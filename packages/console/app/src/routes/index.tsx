...
export default function Home() {
  ...
  return (
    <main data-page="opencode">
      ...
      <Title>RealseeCode | The open source AI coding agent</Title>
        ...
        <div data-component="content">
          ...
          <section data-component="what">
            <div data-slot="section-title">
              <h3>What is RealseeCode?</h3>
              <p>RealseeCode is an open source agent that helps you write code in your terminal, IDE, or desktop.</p>
            </div>
            <ul>
              <li>
                <span>[*]</span>
            ...
            <div data-slot="section-title">
              ...
              <div>
                ...
                <p>
                  ...
                  <strong>{config.stats.commits}</strong> commits, RealseeCode is used and trusted by over{" "}
          ...
          <section data-component="faq">
            ...
            <ul>
              ...
              <li>
                <Faq question="How do I use RealseeCode?">
              ...
              <li>
                <Faq question="Do I need extra AI subscriptions to use RealseeCode?">
                  Not necessarily, RealseeCode comes with a set of free models that you can use without creating an
                  account. Aside from these, you can use any of the popular coding models by creating a{" "}
                  <A href="/zen">Zen</A> account. While we encourage users to use Zen, RealseeCode also works with all
              ...
              <li>
                <Faq question="Can I only use RealseeCode in the terminal?">
                  Not anymore! RealseeCode is now available as an app for your <a href="/download">desktop</a> and{" "}
              ...
              <li>
                <Faq question="Is RealseeCode open source?">
                  Yes, RealseeCode is fully open source. The source code is public on{" "}
          ...
          <section data-component="zen-cta">
            <div data-slot="zen-cta-copy">
              ...
              <p>
                Zen gives you access to a handpicked set of AI models that RealseeCode has tested and benchmarked
