...
function Success(props: SuccessData) {
  return (
    <div data-slot="success">
      <p data-slot="title">You're on the RealseeCode Black waitlist</p>
      <dl data-slot="details">
        <div>
          <dt>Subscription plan</dt>
          <dd>RealseeCode Black {props.plan}</dd>
        </div>
        <div>
          <dt>Amount</dt>
...
export default function BlackSubscribe() {
  ...
  return (
    <>
      <Title>Subscribe to RealseeCode Black</Title>
            ...
            <Match when={true}>
              <>
                <div data-slot="plan-header">
                  <p data-slot="title">Subscribe to RealseeCode Black</p>
                  <p data-slot="price">
