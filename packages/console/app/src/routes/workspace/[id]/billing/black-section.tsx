          ...
          <section class={styles.root}>
            <div data-slot="section-title">
              ...
              <div data-slot="title-row">
                <p>You are subscribed to RealseeCode Black for ${sub().plan} per month.</p>
                <button
                  data-color="primary"
            ...
            <div data-slot="title-row">
              <p>
                {billing()?.timeSubscriptionSelected
                  ? `We're ready to enroll you into the $${billing()?.subscriptionPlan} per month RealseeCode Black plan.`
                  : `You are on the waitlist for the $${billing()?.subscriptionPlan} per month RealseeCode Black plan.`}
              </p>
              <button
                data-color="danger"
