...
export default function Download() {
  ...
  return (
    <main data-page="download">
      <Title>RealseeCode | Download</Title>
      <Link rel="canonical" href={`${config.baseUrl}/download`} />
      <Meta name="description" content="Download RealseeCode for macOS, Windows, and Linux" />
        ...
        <div data-component="content">
          <section data-component="download-hero">
            <div data-component="hero-icon">
              <img src={desktopAppIcon} alt="RealseeCode Desktop" />
            </div>
            <div data-component="hero-text">
              <h1>Download RealseeCode</h1>
          ...
          <section data-component="download-section">
            <div data-component="section-label">
              <span>[1]</span> RealseeCode Terminal
            </div>
          ...
          <section data-component="download-section">
            <div data-component="section-label">
              <span>[2]</span> RealseeCode Desktop (Beta)
            </div>
            <div data-component="section-content">
          ...
          <section data-component="download-section">
            <div data-component="section-label">
              <span>[3]</span> RealseeCode Extensions
            </div>
            <div data-component="section-content">
              <div data-component="download-row">
                <div data-component="download-info">
          ...
          <section data-component="download-section">
            <div data-component="section-label">
              <span>[4]</span> RealseeCode Integrations
            </div>
            <div data-component="section-content">
              <div data-component="download-row">
                <div data-component="download-info">
          ...
          <ul>
            ...
            <li>
              <Faq question="Do I need extra AI subscriptions to use RealseeCode?">
                ...
                for free. While we encourage users to use <A href="/zen">Zen</A>, RealseeCode works with all popular
            ...
            <li>
              <Faq question="What about data and privacy?">
                Your data and information is only stored when you create sharable links in RealseeCode. Learn more about{" "}
