export const dict = {
  ...
  "desktop.updater.none.message": "Korzystasz już z najnowszej wersji RealseeCode",
  ...
  "desktop.updater.downloaded.prompt":
    "Pobrano wersję {{version}} RealseeCode. Czy chcesz ją zainstalować i uruchomić ponownie?",
  ...
  "desktop.error.serverStartFailed.title": "Nie udało się uruchomić RealseeCode",
  "desktop.error.serverStartFailed.description":
    "Nie udało się uruchomić lokalnego serwera RealseeCode. Uruchom ponownie aplikację lub sprawdź ustawienia sieciowe (VPN/proxy) i spróbuj ponownie.",
}
