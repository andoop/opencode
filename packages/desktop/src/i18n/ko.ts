export const dict = {
  ...
  "desktop.updater.none.message": "이미 최신 버전의 RealseeCode를 사용하고 있습니다",
  ...
  "desktop.updater.downloaded.prompt": "RealseeCode {{version}} 버전을 다운로드했습니다. 설치하고 다시 실행할까요?",
  ...
  "desktop.error.serverStartFailed.title": "RealseeCode 시작 실패",
  "desktop.error.serverStartFailed.description":
    "로컬 RealseeCode 서버를 시작할 수 없습니다. 앱을 다시 시작하거나 네트워크 설정(VPN/proxy)을 확인한 후 다시 시도하세요.",
}
