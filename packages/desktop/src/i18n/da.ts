export const dict = {
  ...
  "desktop.updater.none.message": "Du bruger allerede den nyeste version af RealseeCode",
  ...
  "desktop.updater.downloaded.prompt":
    "Version {{version}} af RealseeCode er blevet downloadet. Vil du installere den og genstarte?",
  ...
  "desktop.error.serverStartFailed.description":
    "Den lokale RealseeCode-server kunne ikke startes. Genstart appen, eller tjek dine netværksindstillinger (VPN/proxy) og prøv igen.",
}
