export const dict = {
  ...
  "desktop.updater.none.message": "Você já está usando a versão mais recente do RealseeCode",
  ...
  "desktop.updater.downloaded.prompt":
    "A versão {{version}} do RealseeCode foi baixada. Você gostaria de instalá-la e reiniciar?",
  ...
  "desktop.error.serverStartFailed.title": "Falha ao iniciar o RealseeCode",
  "desktop.error.serverStartFailed.description":
    "Não foi possível iniciar o servidor local do RealseeCode. Reinicie o aplicativo ou verifique suas configurações de rede (VPN/proxy) e tente novamente.",
}
