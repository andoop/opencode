export const dict = {
  ...
  "desktop.updater.none.message": "Du bruker allerede den nyeste versjonen av RealseeCode",
  ...
  "desktop.updater.downloaded.prompt":
    "Versjon {{version}} av RealseeCode er lastet ned. Vil du installere den og starte på nytt?",
  ...
  "desktop.error.serverStartFailed.title": "RealseeCode kunne ikke starte",
  "desktop.error.serverStartFailed.description":
    "Den lokale RealseeCode-serveren kunne ikke startes. Start appen på nytt, eller sjekk nettverksinnstillingene dine (VPN/proxy) og prøv igjen.",
}
