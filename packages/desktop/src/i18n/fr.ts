export const dict = {
  ...
  "desktop.updater.none.message": "Vous utilisez déjà la dernière version de RealseeCode",
  ...
  "desktop.updater.downloaded.prompt":
    "La version {{version}} de RealseeCode a été téléchargée. Voulez-vous l'installer et redémarrer ?",
  ...
  "desktop.error.serverStartFailed.title": "Échec du démarrage de RealseeCode",
  "desktop.error.serverStartFailed.description":
    "Impossible de démarrer le serveur RealseeCode local. Redémarrez l'application ou vérifiez vos paramètres réseau (VPN/proxy) et réessayez.",
}
