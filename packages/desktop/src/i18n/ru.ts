export const dict = {
  ...
  "desktop.updater.none.message": "Вы уже используете последнюю версию RealseeCode",
  ...
  "desktop.updater.downloaded.prompt": "Версия RealseeCode {{version}} загружена. Хотите установить и перезапустить?",
  ...
  "desktop.error.serverStartFailed.title": "Не удалось запустить RealseeCode",
  "desktop.error.serverStartFailed.description":
    "Не удалось запустить локальный сервер RealseeCode. Перезапустите приложение или проверьте настройки сети (VPN/proxy) и попробуйте снова.",
}
