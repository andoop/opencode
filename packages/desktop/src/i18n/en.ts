export const dict = {
  ...
  "desktop.updater.none.message": "You are already using the latest version of RealseeCode",
  ...
  "desktop.updater.downloaded.prompt":
    "Version {{version}} of RealseeCode has been downloaded, would you like to install it and relaunch?",
  ...
  "desktop.error.serverStartFailed.title": "RealseeCode failed to start",
  "desktop.error.serverStartFailed.description":
    "The local RealseeCode server could not be started. Restart the app, or check your network settings (VPN/proxy) and try again.",
}
