export const dict = {
  ...
  "desktop.updater.none.message": "Sie verwenden bereits die neueste Version von RealseeCode",
  ...
  "desktop.updater.downloaded.prompt":
    "Version {{version}} von RealseeCode wurde heruntergeladen. Möchten Sie sie installieren und neu starten?",
  ...
  "desktop.error.serverStartFailed.title": "RealseeCode konnte nicht gestartet werden",
  "desktop.error.serverStartFailed.description":
    "Der lokale RealseeCode-Server konnte nicht gestartet werden. Starten Sie die App neu oder überprüfen Sie Ihre Netzwerkeinstellungen (VPN/Proxy) und versuchen Sie es erneut.",
}
