export const dict = {
  ...
  "desktop.updater.none.message": "Ya estás usando la versión más reciente de RealseeCode",
  ...
  "desktop.updater.downloaded.prompt":
    "Se ha descargado la versión {{version}} de RealseeCode. ¿Quieres instalarla y reiniciar?",
  ...
  "desktop.error.serverStartFailed.title": "RealseeCode no pudo iniciarse",
  "desktop.error.serverStartFailed.description":
    "No se pudo iniciar el servidor local de RealseeCode. Reinicia la aplicación o revisa tu configuración de red (VPN/proxy) y vuelve a intentarlo.",
}
