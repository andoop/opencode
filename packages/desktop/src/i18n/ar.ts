export const dict = {
  ...
  "desktop.updater.none.message": "أنت تستخدم بالفعل أحدث إصدار من RealseeCode",
  ...
  "desktop.updater.downloaded.prompt": "تم تنزيل إصدار {{version}} من RealseeCode، هل ترغب في تثبيته وإعادة تشغيله؟",
  ...
  "desktop.error.serverStartFailed.title": "فشل تشغيل RealseeCode",
  "desktop.error.serverStartFailed.description":
    "تعذر بدء تشغيل خادم RealseeCode المحلي. أعد تشغيل التطبيق، أو تحقق من إعدادات الشبكة (VPN/proxy) وحاول مرة أخرى.",
}
